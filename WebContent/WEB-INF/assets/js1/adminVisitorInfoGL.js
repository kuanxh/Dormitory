 ...
 */
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			//direction: "rtl",
			url : 'http://localhost:8080/Dormitory/info/adminVisitor',
        	datatype : "json",
...
//			datatype: "local",
			...
			colModel:[
				...
				{name:'qq',index:'qq', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}}
			], 
